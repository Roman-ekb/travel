...
var _sliderHero = require("./modules/hero/slider-hero");
var _playVideo = require("./modules/hero/play-video");
var _sliderTours = require("./modules/tours/slider-tours");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/header/burger":9,"./modules/hero/play-video":12,"./modules/hero/slider-hero":13,"./modules/tours/slider-tours":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":10,"./scroll-lock":11}],10:[function(require,module,exports){
"use strict";
...
var frames = document.querySelectorAll('.about__video iframe');
  ...
  if (playButton) {
    playButton.addEventListener('click', function (evt) {
      if (frames) {
        ...
        var frame = evt.target.closest('.about__video');
...
exports.sliderHero = void 0;
var sliderHero = exports.sliderHero = new window.Swiper('.hero__swiper', {
  loop: true,
  pagination: {
...
exports.sliderTours = void 0;
var sliderTours = exports.sliderTours = new window.Swiper('.tours__swiper', {
  breakpoints: {
